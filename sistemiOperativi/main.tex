...
\begin{document}
    ...
    \include{chapters/01-definizioneStoria}
    \include{chapters/02-componentiSO}
    \include{chapters/03-architetturaSistemaOperativo}
    \include{chapters/04-processiThread}
    \include{chapters/05-comunicazioneTraProcess}
    \include{chapters/06-schedulingCPU}
    \include{chapters/07-sincronizzazioneProcessi}
    \include{chapters/08-deadlock}
    \include{chapters/09-gestioneDellaMemoria}
    \include{chapters/10-memoriaVirtuale}
    \include{chapters/11-memoriaSecondaria}
    \include{chapters/12-fileSystem}
    \include{chapters/13-RAID}
    \include{chapters/14-IO}
\end{document}
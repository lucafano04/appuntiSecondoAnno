...
\begin{document}
    ...
    \part{Primo Semestre}
    \include{chapters/01-AnalisiAlgoritmi}
    \include{chapters/02-AnalisiFunzioni}
    \include{chapters/03-Alberi}
    \include{chapters/04-AlberiBinariRicerca}
    \include{chapters/05-grafi}
    \include{chapters/06-hashing}
    \include{chapters/07-divideEtImpera}
    \include{chapters/08-AnalisiAmmortizzata}
    \include{chapters/09-struttureDatiSpeciali}
    \part{Secondo Semestre}
    \include{chapters/10-programmazioneDinamica}
    \include{chapters/11-sceltaStrutturaDati}
    \include{chapters/12-gready}
    \include{chapters/13-backtracking}
    \include{chapters/14-problemiIntrattabili}
\end{document}